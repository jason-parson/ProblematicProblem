...
namespace ProblematicProblem
{
     class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            bool cont;
            var contResponse = Console.ReadLine().ToLower().ToLower();
            ...
            bool seeList;
            var secResponse = Console.ReadLine().ToLower();
            ...
            while (cont)
            {
                ...
                Console.WriteLine();
                bool grab;
                var grabResponse = Console.ReadLine().ToLower();

                if (grabResponse == "Keep")
                {
